...
const Components = () => (
  <div>
    <Link to="/" activeStyle={{ zIndex: 9999 }}>Back to home</Link>
    <div className="navbar navbar-expand-lg navbar-light bg-light">
      <div className="container">
        <a href="https://bootswatch.com/" className="navbar-brand">Bootswatch</a>
        ...
        <div className="collapse navbar-collapse" id="navbarResponsive">
          <ul className="navbar-nav">
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle" data-toggle="dropdown" href="https://bootswatch.com/default/#" id="themes">Themes<span className="caret" /></a>
              <div className="dropdown-menu" aria-labelledby="themes">
                <a className="dropdown-item" href="https://bootswatch.com/default/">Default</a>
                <div className="dropdown-divider" />
                <a className="dropdown-item" href="https://bootswatch.com/cerulean/">Cerulean</a>
                <a className="dropdown-item" href="https://bootswatch.com/cosmo/">Cosmo</a>
                <a className="dropdown-item" href="https://bootswatch.com/cyborg/">Cyborg</a>
                <a className="dropdown-item" href="https://bootswatch.com/darkly/">Darkly</a>
                <a className="dropdown-item" href="https://bootswatch.com/flatly/">Flatly</a>
                <a className="dropdown-item" href="https://bootswatch.com/journal/">Journal</a>
                <a className="dropdown-item" href="https://bootswatch.com/litera/">Litera</a>
                <a className="dropdown-item" href="https://bootswatch.com/lumen/">Lumen</a>
                <a className="dropdown-item" href="https://bootswatch.com/lux/">Lux</a>
                <a className="dropdown-item" href="https://bootswatch.com/materia/">Materia</a>
                <a className="dropdown-item" href="https://bootswatch.com/minty/">Minty</a>
                <a className="dropdown-item" href="https://bootswatch.com/pulse/">Pulse</a>
                <a className="dropdown-item" href="https://bootswatch.com/sandstone/">Sandstone</a>
                <a className="dropdown-item" href="https://bootswatch.com/simplex/">Simplex</a>
                <a className="dropdown-item" href="https://bootswatch.com/sketchy/">Sketchy</a>
                <a className="dropdown-item" href="https://bootswatch.com/slate/">Slate</a>
                <a className="dropdown-item" href="https://bootswatch.com/solar/">Solar</a>
                <a className="dropdown-item" href="https://bootswatch.com/spacelab/">Spacelab</a>
                <a className="dropdown-item" href="https://bootswatch.com/superhero/">Superhero</a>
                <a className="dropdown-item" href="https://bootswatch.com/united/">United</a>
                <a className="dropdown-item" href="https://bootswatch.com/yeti/">Yeti</a>
              </div>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="https://bootswatch.com/help/">Help</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="http://blog.bootswatch.com/">Blog</a>
            </li>
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle" data-toggle="dropdown" href="https://bootswatch.com/default/#" id="download">Default <span className="caret" /></a>
              <div className="dropdown-menu" aria-labelledby="download">
                <a className="dropdown-item" href="https://jsfiddle.net/bootswatch/mLascy62/">Open in JSFiddle</a>
                <div className="dropdown-divider" />
                <a className="dropdown-item" href="https://bootswatch.com/_vendor/bootstrap/dist/css/bootstrap.min.css">bootstrap.min.css</a>
                <a className="dropdown-item" href="./Bootswatch_ Default_files/bootstrap.css">bootstrap.css</a>
              </div>
            </li>
          </ul>
          ...
          <ul className="nav navbar-nav ml-auto">
            <li className="nav-item">
              <a className="nav-link" href="http://builtwithbootstrap.com/">Built With Bootstrap</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="https://wrapbootstrap.com/?ref=bsw">WrapBootstrap</a>
            </li>
          </ul>
        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
                <a className="navbar-brand" href="https://bootswatch.com/default/#">Navbar</a>
                ...
                <ul className="navbar-nav mr-auto">
                    ...
                    <a className="nav-link" href="https://bootswatch.com/default/#">Home <span className="sr-only">(current)</span></a>
                    </li>
                    <li className="nav-item">
                    <a className="nav-link" href="https://bootswatch.com/default/#">Features</a>
                    </li>
                    <li className="nav-item">
                    <a className="nav-link" href="https://bootswatch.com/default/#">Pricing</a>
                    </li>
                    <li className="nav-item">
                    <a className="nav-link" href="https://bootswatch.com/default/#">About</a>
                    </li>
                </ul>
            ...
            <div id="source-button" className="btn btn-primary btn-xs">&lt; &gt;</div>
            </div>
            ...
            <div className="btn-group" role="group" aria-label="Button group with nested dropdown">
              ...
              <div className="btn-group" role="group">
                ...
                <div className="dropdown-menu" aria-labelledby="btnGroupDrop1">
                  <a className="dropdown-item" href="https://bootswatch.com/default/#">Dropdown link</a>
                  <a className="dropdown-item" href="https://bootswatch.com/default/#">Dropdown link</a>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-6">
            ...
            <div className="bs-component">
              <ul className="nav nav-tabs">
                <li className="nav-item">
                  <a className="nav-link active" data-toggle="tab" href="https://bootswatch.com/default/#home">Home</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" data-toggle="tab" href="https://bootswatch.com/default/#profile">Profile</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link disabled" href="https://bootswatch.com/default/#">Disabled</a>
                </li>
                <li className="nav-item dropdown">
                  <a className="nav-link dropdown-toggle" data-toggle="dropdown" href="https://bootswatch.com/default/#" role="button" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                  <div className="dropdown-menu">
                    <a className="dropdown-item" href="https://bootswatch.com/default/#">Action</a>
                    <a className="dropdown-item" href="https://bootswatch.com/default/#">Another action</a>
                    <a className="dropdown-item" href="https://bootswatch.com/default/#">Something else here</a>
                    <div className="dropdown-divider" />
                    <a className="dropdown-item" href="https://bootswatch.com/default/#">Separated link</a>
                  </div>
                </li>
              </ul>
          ...
          <div className="col-lg-6">
            ...
            <div className="bs-component">
              <ul className="nav nav-pills">
                <li className="nav-item">
                  <a className="nav-link active" href="https://bootswatch.com/default/#">Active</a>
                </li>
                <li className="nav-item dropdown">
                  <a className="nav-link dropdown-toggle" data-toggle="dropdown" href="https://bootswatch.com/default/#" role="button" aria-haspopup="true" aria-expanded="false">Dropdown</a>
                  <div className="dropdown-menu">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="https://bootswatch.com/default/#">Link</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link disabled" href="https://bootswatch.com/default/#">Disabled</a>
                </li>
        ...
        <div className="row">
          <div className="col-lg-6">
            ...
            <div className="bs-component">
              ...
              <ol className="breadcrumb">
                <li className="breadcrumb-item"><a href="https://bootswatch.com/default/#">Home</a></li>
                <li className="breadcrumb-item active">Library</li>
              </ol>
              <ol className="breadcrumb">
                <li className="breadcrumb-item"><a href="https://bootswatch.com/default/#">Home</a></li>
                <li className="breadcrumb-item"><a href="https://bootswatch.com/default/#">Library</a></li>
              ...
              <div>
                <ul className="pagination">
                  <li className="page-item disabled">
                    <a className="page-link" href="https://bootswatch.com/default/#">«</a>
                  </li>
                  <li className="page-item active">
                    <a className="page-link" href="https://bootswatch.com/default/#">1</a>
                  </li>
                  <li className="page-item">
                    <a className="page-link" href="https://bootswatch.com/default/#">2</a>
                  </li>
                  <li className="page-item">
                    <a className="page-link" href="https://bootswatch.com/default/#">3</a>
                  </li>
                  <li className="page-item">
                    <a className="page-link" href="https://bootswatch.com/default/#">4</a>
                  </li>
                  <li className="page-item">
                    <a className="page-link" href="https://bootswatch.com/default/#">5</a>
                  </li>
                  <li className="page-item">
                    <a className="page-link" href="https://bootswatch.com/default/#">»</a>
                  </li>
          ...
          <div className="col-lg-12">
            ...
            <div className="bs-component">
              <div className="alert alert-dismissible alert-warning">
                ...
                <p className="mb-0">Best check yo self, you&apos;re not looking too good. Nulla vitae elit libero, a pharetra augue. Praesent commodo cursus magna, <a href="https://bootswatch.com/default/#" className="alert-link">vel scelerisque nisl consectetur et</a>.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-4">
            <div className="bs-component">
              <div className="alert alert-dismissible alert-danger">
                <button type="button" className="close" data-dismiss="alert">×</button>
                <strong>Oh snap!</strong> <a href="https://bootswatch.com/default/#" className="alert-link">Change a few things up</a> and try submitting again.
              </div>
            </div>
          </div>
          <div className="col-lg-4">
            <div className="bs-component">
              <div className="alert alert-dismissible alert-success">
                <button type="button" className="close" data-dismiss="alert">×</button>
                <strong>Well done!</strong> You successfully read <a href="https://bootswatch.com/default/#" className="alert-link">this important alert message</a>.
              </div>
            </div>
          </div>
          <div className="col-lg-4">
            <div className="bs-component">
              <div className="alert alert-dismissible alert-info">
                <button type="button" className="close" data-dismiss="alert">×</button>
                <strong>Heads up!</strong> This <a href="https://bootswatch.com/default/#" className="alert-link">alert needs your attention</a>, but it&apos;s not super important.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <div className="bs-component">
              ...
              <div className="progress">
                <div className="progress-bar bg-danger" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" />
              </div>
            </div>
            ...
            <div className="bs-component">
              <div className="progress">
                <div className="progress-bar" role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" />
                <div className="progress-bar bg-success" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" />
                <div className="progress-bar bg-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" />
              </div>
            </div>
            ...
            <div className="bs-component">
              <div className="progress">
                <div className="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" />
              </div>
              <div className="progress">
                <div className="progress-bar progress-bar-striped bg-success" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" />
              </div>
              <div className="progress">
                <div className="progress-bar progress-bar-striped bg-info" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" />
              </div>
              <div className="progress">
                <div className="progress-bar progress-bar-striped bg-warning" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" />
              </div>
              <div className="progress">
      ...
      <div className="bs-docs-section">
          ...
          <div className="col-lg-12">
            ...
            <div className="bs-component">
              <div className="jumbotron">
                ...
                <p className="lead">
                  <a className="btn btn-primary btn-lg" href="https://bootswatch.com/default/#" role="button">Learn more</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            <div className="bs-component">
              <div className="list-group">
                <a href="https://bootswatch.com/default/#" className="list-group-item list-group-item-action active">
                  Cras justo odio
                </a>
                <a href="https://bootswatch.com/default/#" className="list-group-item list-group-item-action">Dapibus ac facilisis in
                </a>
                <a href="https://bootswatch.com/default/#" className="list-group-item list-group-item-action disabled">Morbi leo risus
                </a>
              </div>
            </div>
          </div>
          <div className="col-lg-4">
            <div className="bs-component">
              <div className="list-group">
                <a href="https://bootswatch.com/default/#" className="list-group-item list-group-item-action flex-column align-items-start active">
                ...
                <a href="https://bootswatch.com/default/#" className="list-group-item list-group-item-action flex-column align-items-start">
                  <div className="d-flex w-100 justify-content-between">
                    <h5 className="mb-1">List group item heading</h5>
          ...
          <div className="col-lg-4">
            <div className="bs-component">
              <div className="card mb-3">
                ...
                <div className="card-body">
                  <a href="https://bootswatch.com/default/#" className="card-link">Card link</a>
                  <a href="https://bootswatch.com/default/#" className="card-link">Another link</a>
                </div>
